                    ...
                    <div class="form-box">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div style="display: flex; flex-direction: column; gap: 22px">
                                {{-- Clinic Name --}}
                                <input type="text" name="clinic_name" placeholder="Clinic name" value="{{ old('clinic_name') }}" required />
                                ...
                                <div style="position: relative">
                                    <input type="password" name="password_confirmation" id="confirmPassword"
                                        placeholder="Confirm password" style="padding-right: 30px" required />
                                    <span class="togglePassword" data-target="confirmPassword"
                                        style="
                                            position: absolute;
                                            right: 5px;
                                            top: 53%;
                                ...
                                <div
                                    ...
                                    <input type="checkbox" name="terms" class="custom-control-input"
                                        id="outline-chekbox-primary" required>
                                    <label class="custom-control-label" for="outline-chekbox-primary">
                                        By entering your details, you agree with our Terms & Conditions, Privacy Policy
                                    </label>
                                </div>
                            </div>
